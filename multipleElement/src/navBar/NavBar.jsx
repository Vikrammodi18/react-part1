...
function NavBar(){
    ...
    return(
        <>
        <nav className="w-3xl px-4 py-3 h-18 border-1  rounded-xl flex flex-wrap justify-between content-center shadow-xl ">
            ...
            <div>
                <ul className="flex flex-wrap gap-2 content-center py-2">
                    ...
                    <li><a className="hover:text-gray-500" href="#">About us</a></li>
