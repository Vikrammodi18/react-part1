...
function Search ({setSearchData}){
    ...
    return(
        <>
        <div className="m-5 border-1 shadow-xl  flex justify-between inline-block rounded-xl overflow-hidden ">
            ...
            <button onClick={searchedButton} className="bg-gray-500 px-3 py-2 hover:bg-gray-400 text-lg ">search</button>
        </div>
        </>
    )
}
